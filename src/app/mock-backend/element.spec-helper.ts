...
export function findElWithoutId<T>(fixture: ComponentFixture<T>, testId: string): DebugElement {
  return queryByCss<T>(fixture, testId);
}

export function markFieldAsTouched<T>(fixture: ComponentFixture<T>, testId: string): void {
 ...
 * @param value The object representing the event value
 */
export function triggerEvent<T>(fixture: ComponentFixture<T>, testId: string, eventName: string, value = {}): void {
  const element = findEl(fixture, testId);
  element.triggerEventHandler(eventName, value);
}
