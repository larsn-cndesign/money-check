...
/**
 * A validator factory function that check if a budget name exist in an array of `Budget` objects.
 * @param service A service managing budgets.
 ...
 */
export const duplicateValidator = (service: BudgetService, control: string, action: string): ValidatorFn => {
